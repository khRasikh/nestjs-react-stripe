    ...
    <>
      <div className="absolute bg-gray-100 w-full">
        ...
        >
          ...
          />
          <div className="w-64absolute left-0 z-40 top-0 bg-white shadow flex-col justify-between transition duration-150 ease-in-out h-full">
          ...
          <div className="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto">
            <div className="h-full flex items-center">
              <div className="mr-10 flex items-center">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-7 h-7 text-green-900 text-bold"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div className="w-full h-full flex items-center">
                ...
                <div className="w-full h-full flex">
                  <div className="w-32 h-full flex items-center justify-center border-r cursor-pointer text-gray-600">
                    ...
                    <button
                      type="button"
                      className="inline-flex relative items-center px-3 text-sm font-medium text-center text-black focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                  ...
                  >
                    {profile ? (
                      <ul className="p-2 w-40 border-r bg-white absolute rounded z-40 left-0 shadow mt-64 ">
                        ...
                        <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 focus:outline-none flex items-center">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 focus:outline-none">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="visible xl:hidden flex items-center relative">
              <ul className="p-2 w-64 border-r bg-white absolute top-0 -ml-2 rounded right-0 shadow mt-12 lg:mt-16 hidden">
                <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 focus:outline-none">
                  <div className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="icon icon-tabler icon-tabler-user"
